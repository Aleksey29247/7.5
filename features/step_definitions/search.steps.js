...
When("user one ticket", async function () {
  await clickElement(this.page, "nav > .page-nav__day:nth-child(3)");
  await clickElement(
    this.page,
...
When("user  two tickets", async function () {
  await clickElement(this.page, "nav > .page-nav__day:nth-child(2)");
  await clickElement(
    this.page,
    "section:nth-child(2) > div:nth-child(2) > ul > li"
  );
  ...
  await clickElement(
    this.page,
    ".buying-scheme__wrapper > .buying-scheme__row:nth-child(10) > .buying-scheme__chair:nth-child(2)"
  );
  await clickElement(this.page, ".acceptin-button");
});

When("unavailable ticket", async function () {
